  ...
  const hooks = {
    'initialize': function () {
      var _initialize = _asyncToGenerator(function* () {
        ...
        const _ref = yield getMetadata(),
              supportedRuntimes = _ref.supportedRuntimes,
              supportedRegions = _ref.supportedRegions;
...
`); // setup deploy if user already logged in so that AWS creds check in SFO works right
          ...
          if (user) yield configureDeployProfile(_objectSpread({}, ctx, {
